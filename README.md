...
│  │                                                        │ │
│  │  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐     │ │
│  │  │ FIX Session │  │ FIX Message │  │   Message   │     │ │
│  │  │  Management │  │   Parser    │  │   Builder   │     │ │
│  │  │             │  │             │  │             │     │ │
│  │  │ • 序列號管理 │  │ • 訊息解析  │  │ • 訊息構建  │     │ │
│  │  │ • 心跳處理  │  │ • 欄位驗證  │  │ • 檢查碼計算 │     │ │
│  │  │ • 登入驗證  │  │ • 檢查碼驗證 │  │ • 序列化    │     │ │
...
#### 1. **TradingSystem** (交易系統主控制器)
- **職責**：系統的中央協調者，管理所有客戶端連線和訊息處理
- **功能**：
  - 客戶端會話生命週期管理
  - FIX 訊息的接收、解析和回應
  - 訂單 ID 與客戶端的映射關係
...
```
客戶端                FIX Layer              Trading System         Matching Engine        Order Book
   │                     │                        │                      │                    │
   │─── 新訂單 (D) ────────►│                        │                      │                    │
   │                     │                        │                      │                    │
   │                     │─── 解析訊息 ─────────────►│                      │                    │
